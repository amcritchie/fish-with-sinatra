...
feature "Homepage" do
  ...
  scenario "salmon page" do
    ...
    expect(page).to have_link('Salmon Wiki', :href => "http://en.wikipedia.org/wiki/Atlantic_salmon")
  ...
  scenario "trout page" do
    ...
    expect(page).to have_link('Trout Wiki', :href => "http://en.wikipedia.org/wiki/Brown_trout")
    expect(page).to have_link('Homepage', :href => "/")
  end
  ...
  scenario "halibut page" do
    ...
    expect(page).to have_link('Halibut Wiki', :href => "http://en.wikipedia.org/wiki/Atlantic_halibut")
    expect(page).to have_link('Homepage', :href => "/")
  end
